...
public class TestMap extends AppCompatActivity
    ...
    // PlaceListener 인터페이스를 상속받기 위해 요구하는 4개의 메서드
    @Override
  ...
  /*  public void showPlaceInformation(LatLng location)
    {
        ...
        new NRPlaces.Builder()
                .listener(TestMap.this)
                .key("AIzaSyBM0eam_Az2LwnqQfp3O0yXLL3mnAH4Nyg")
                .latlng(location.latitude, location.longitude)//현재 위치
                .radius(10000) // 검색 범위
                .type(this.category) // 검색할 장소
                .language("ko", "KR")
                .build()
                .execute();
    }*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent it = getIntent();
        category = it.getExtras().getString("text1_KEY");
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                /*Intent it = new Intent(TestMap.this, ProjectAndroid0212Next.class);
                startActivity(it);*/
    ...
    public void setCurrentLocation(Location location, String markerTitle, String markerSnippet) {
        ...
        new NRPlaces.Builder()
                .listener(TestMap.this)
                .key("AIzaSyAjHl1I1Irdgy9vYc6h9jdErBGlvGDOQNg")
                .latlng(currentPosition.latitude, currentPosition.longitude)//현재 위치
                .radius(3000) // 검색 범위
                .type(this.category) // 검색할 장소
                .language("ko", "KR")
    ...
    private void showDialogForPermission(String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(TestMap.this);
        builder.setTitle("알림");
